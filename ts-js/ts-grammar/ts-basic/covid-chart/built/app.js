...
fetchCovidSummary().then(function (res) { return res.data.Countries; });
var CovidStatus;
...
function setTotalConfirmedNumber(data) {
    confirmedTotal.innerText = data.Countries.reduce(function (total, current) { return (total += current.TotalConfirmed); }, 0).toString(); // data.Countries.reduce return number -> string type
}
